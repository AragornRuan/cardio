...
*时间:		2014/12/8
**************************************************************/
void pretreat(string filepath,fmat& val,u32& sfreq,u32& repeat,float& TS,u32& gain)
{
...
fmat learn(int sfreq, fmat& x_stt)
{
	...
	clock_t end = clock();
	cout << "learning time:" << (end - start) / (float)CLOCKS_PER_SEC << " seconds!" << endl;
...
int main(int argc, char** argv)
{
	...
	float TS = 0.0;
	pretreat(filepath, val, sfreq, repeat, TS, gain);
